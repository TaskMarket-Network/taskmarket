...
import { AGENT_REGISTRY_ERROR_CODES, AgentRegistryError } from '../errors.js';
 ...
 * documentation generation. Throws {@link AgentRegistryError} for schema kinds
...
export function zodToJsonSchema(schema: z.ZodType): JsonSchema {
  ...
  throw new AgentRegistryError(
    AGENT_REGISTRY_ERROR_CODES.SCHEMA_UNSUPPORTED,
