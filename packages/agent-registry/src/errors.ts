...
export const AGENT_REGISTRY_ERROR_CODES = {
  ...
  REQUEST_INVALID: 'AGENT_REGISTRY_REQUEST_INVALID',
  UNSUPPORTED_VERSION: 'AGENT_REGISTRY_UNSUPPORTED_VERSION',
  UNAUTHORIZED: 'AGENT_REGISTRY_UNAUTHORIZED',
  INTERNAL: 'AGENT_REGISTRY_INTERNAL',
  SCHEMA_UNSUPPORTED: 'AGENT_REGISTRY_SCHEMA_UNSUPPORTED',
} as const;
